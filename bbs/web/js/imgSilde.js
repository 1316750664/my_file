...
$("#pagination li a").bind("focus",function() {if(this.blur) {this.blur()};});
...
function imgshow(nownow){
	if($("#focusimgtitle").length == 1){
		$("#focusimgtitle li").hide();
		$("#focusimgtitle li").eq(nownow).show();
	}
}