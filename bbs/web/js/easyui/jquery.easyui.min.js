...
(function ($) {
    ...
    var _5ea = {text: {init: function (_5eb, _5ec) {
        if(!_5ec){//hzm2014-4-15 10:15增加options
            _5ec={};
        }
        var _5ed = $("<input type=\"text\" class=\"datagrid-editable-input\">").attr(_5ec).appendTo(_5eb);
        return _5ed;
    ...
    var _65a = {render: function (_65b, _65c, _65d) {
        ...
        $(_65c).html(_660.join(""));//hzm 2017-08-12 14:14
        //$(_65c).innerHTML = _660.join("");
        ...
        $(_666).html(_669.join(""));//hzm 2017-08-12 14:14
        //$(_666).innerHTML = _669.join("");
...
(function ($) {
    ...
    function _731(_732, _733) {
        ...
        if (row._parentId&&row._parentId!=null) {
