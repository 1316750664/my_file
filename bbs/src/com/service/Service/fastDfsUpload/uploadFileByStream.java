package com.service.Service.fastDfsUpload;
...
public class uploadFileByStream {
    ...
    public String[] uploadFileBySteam(InputStream inputStream,String suffix) throws Exception {
...
//        System.out.println("配置文件:" + configFilePath);
        ...
        meta_list[2] = new NameValuePair("author", "hty");
...
//        System.out.println("file length: " + file_buff.length);
        ...
        String[] results = storageClient.upload_file(file_buff, suffix, meta_list);
