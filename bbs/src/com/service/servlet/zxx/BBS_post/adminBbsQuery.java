 ...
 */
@WebServlet(name = "adminBbsQuery", urlPatterns = {"/Action/adminBbsQuery.do"})
public class adminBbsQuery extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if(!CheckTools.isNull(user_name)){
                sqlWhere+= " and instr (topic,'"+user_name+"')";
            }
            Map<String,String[]> paramMap=new HashMap<String,String[]>();
            Map<String,Object> map=new HashMap<>();
            paramMap.put("taskId",new String[]{"1160"});
