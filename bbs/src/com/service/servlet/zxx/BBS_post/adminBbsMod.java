 ...
 */
@WebServlet(name = "adminBbsMod", urlPatterns = {"/Action/adminBbsMod.do"})
public class adminBbsMod extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String is_elite=request.getParameter("is_elite");
            if(!CheckTools.checkIsNum(post_id)||!CheckTools.checkIsNum(is_elite)){
                out.write("301");
                out.flush();
                return;
            }
